...
class _TaskListScreenState extends State<TaskListScreen> {
  ...
  void _addTask() {
    if (_taskController.text.isNotEmpty) {
      _firestore.collection('tasks').add({
        ...
        'isCompleted': false,
        'subTasks': [], // Empty list for future subtasks
  ...
  void _addSubtask(DocumentSnapshot taskDoc) {
    if (_subtaskController.text.isNotEmpty) {
      // Add new subtask to the list of subtasks
      taskDoc.reference.update({
        'subTasks': FieldValue.arrayUnion([
          {'detail': _subtaskController.text, 'time': DateTime.now().toString()}
        ])
      });
